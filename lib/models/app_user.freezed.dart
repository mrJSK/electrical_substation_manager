...
mixin _$AppUser {
  ...
  Map<String, dynamic> get roleData => throw _privateConstructorUsedError;
...
class _$AppUserImpl extends _AppUser {
  ...
  @override
  String toString() {
    return 'AppUser(uid: $uid, email: $email, name: $name, photoUrl: $photoUrl, role: $role, hierarchyId: $hierarchyId, permissions: $permissions, roleData: $roleData, lastLogin: $lastLogin, isActive: $isActive, lastSynced: $lastSynced)';
  }
