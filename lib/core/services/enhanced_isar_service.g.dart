...
void _cachedUserPermissionsSerialize(
  ...
  writer.writeStringList(offsets[3], object.permissions);
...
CachedUserPermissions _cachedUserPermissionsDeserialize(
  ...
  object.id = id;
  object.permissions = reader.readStringList(offsets[3]) ?? [];
...
void _cachedWidgetDataSerialize(
  ...
  writer.writeBool(offsets[3], object.isExpired);
  writer.writeString(offsets[4], object.userId);
  writer.writeString(offsets[5], object.widgetId);
}
...
CachedWidgetData _cachedWidgetDataDeserialize(
  ...
  object.id = id;
  object.userId = reader.readString(offsets[4]);
  object.widgetId = reader.readString(offsets[5]);
  return object;
}
